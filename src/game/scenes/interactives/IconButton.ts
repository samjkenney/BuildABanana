...
export class IconButton extends ImageButton{
    ...
    constructor(scene: Scene, x: number, y: number, imageKey: string, category: string, container: GameObjects.Container, bananaContainer: GameObjects.Container){
        var action = () => {
        ...
        super(scene, x, y, container.width * 0.35, container.height * 0.35, IconButton.COLOR, imageKey, true, action);
