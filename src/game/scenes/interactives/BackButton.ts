...
export class BackButton extends SceneButton{
    ...
    constructor(scene: Scene, previousScene: string){
        super(scene, scene.scale.baseSize.width * 0.1, scene.scale.baseSize.height * 0.1, BackButton.WIDTH, BackButton.HEIGHT, 0xF9B1B4, "<", new GameObjects.Text(scene, 0, 0 , "button", TextStyles.button).style, false, true, previousScene);
